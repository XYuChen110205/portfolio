...
// ========== v2 — Extend i18nMap with new keys ==========
(function() {
  var v2 = {
    zh: {
      nav_hometown: '家乡',
      ...
      view_all_photos: '展开全部照片',
      collapse_photos: '收起全部照片',
      sec_hometown_tag: 'HOMETOWN',
      sec_hometown_title: '我的家乡 · 梧州',
      sec_hometown_desc: '梧州，一座被江水环绕的千年古城。龙母文化源远流长，骑楼老街见证岁月变迁。',
      sec_school_tag: 'ALMA MATER',
      sec_school_title: '北部湾大学',
      sec_school_desc: '坐落于钦州湾畔，晚霞、湖泊与格桑花海交织出最美的大学时光。',
      sec_portfolio_tag: 'PORTFOLIO',
      sec_portfolio_title: '项目作品集',
      sec_portfolio_desc: '在 AI 辅助下完成的计算机视觉与全栈项目。点击图片查看详情。',
      sec_more_tag: 'MORE WORKS',
      sec_more_title: '其他项目',
      sec_more_desc: '更多练手项目与实验作品。',
      sec_challenges_tag: 'CHALLENGES & INTERESTS',
      sec_challenges_title: '兴趣与挑战',
      sec_challenges_desc: '学习之外的探索与实践。',
      sec_contact_tag: 'CONTACT',
      sec_contact_title: '联系方式',
      sec_contact_desc: '欢迎交流与合作。',
      hero_greeting_v2: '你好，我是',
      hero_title_v2: '计算机视觉探索者',
      hero_desc_v2: '在 AI 辅助下，探索计算机视觉、深度学习与 Web 技术的交叉地带。',
      hero_stat_years_v2: '年探索',
      hero_tools_label: 'Tools &amp; Playground',
      hero_tools_desc: '探索 Python · PyTorch · YOLO · FastAPI · Vue 等技术，在 AI 辅助下完成多个实战项目。',
      challenges_label: '挑战',
      interests_label: '兴趣',
      ci_challenges_desc: '电工接线、电路焊接、电子竞赛——从零开始的工科实践之路。',
      ci_interests_desc: '阅读、探索、持续学习。',
      carousel_prev: '上一张',
      carousel_next: '下一张',
      proj_demo_link: '在线体验 →',
      proj_no_image: '暂无项目截图',
      hometown_more: '更多照片即将添加',
      timeline_stage1_title: '编程启蒙',
      timeline_stage1_desc: '从 Hello World 起步，开启技术探索之旅。',
      timeline_stage2_title: '基础构建',
      timeline_stage2_desc: '系统学习编程语言与数据结构，完成多个练手项目。',
      timeline_stage3_title: 'AI 与全栈入门',
      timeline_stage3_desc: '学习深度学习、计算机视觉与 Web 全栈技术，在 AI 辅助下完成多个实战项目。',
      timeline_stage4_title: '持续探索',
      timeline_stage4_desc: '深入 AI Agent、计算机视觉等前沿领域，参加挑战杯、黑客松等比赛，持续将技术落地为产品。',
      footer_built_v2: 'AI Assisted · 独立开发 · © 2026 Seeyu',
      page_title_v2: 'Seeyu · 个人主页',
      page_desc_v2: 'Seeyu 的个人主页 — 计算机视觉探索者，家乡梧州，北部湾大学',
      tw_roles_v2: ['AI探索者', '计算机视觉', 'Web 开发者'],
      sec_challenges_desc: '电工实训、英语竞赛、硬件DIY',
      sec_portfolio_desc: 'AI、CV、Web全栈等多领域项目',
      sec_contact_desc: '欢迎技术交流与合作探讨',
      timeline_stage1_title: '初识编程',
      timeline_stage1_desc: '大一接触 Python 与 C 语言',
      timeline_stage2_title: '深入学习',
      timeline_stage2_desc: 'Web 全栈、数据库、网络',
      timeline_stage3_title: '项目实践',
      timeline_stage3_desc: '多个 AI 与 Web 项目，竞赛获奖',
      timeline_stage4_title: '持续进阶',
      timeline_stage4_desc: 'AI Agent、CV、大模型应用',
      footer_built_v2: '&copy; 2025 Seeyu &middot; AI Assisted',
      page_title_v2: 'Seeyu &middot; 个人主页',
      page_desc_v2: 'Seeyu 的个人网站',
      challenges_label: '挑战',
      interests_label: '兴趣',
      view_all_photos: '展开全部照片',
      collapse_photos: '收起全部照片',
    ...
    en: {
      nav_hometown: 'Hometown',
      nav_school: 'School',
      nav_challenges: 'Challenges',
      nav_portfolio: 'Portfolio',
      view_all_projects: 'View All Projects',
      view_all_photos: 'View All Photos',
      collapse_photos: 'Collapse Photos',
      sec_hometown_tag: 'HOMETOWN',
      sec_hometown_title: 'Wuzhou · My Hometown',
      sec_hometown_desc: 'An ancient city embraced by rivers, home to the Dragon Mother culture with century-old arcade streets.',
      sec_school_tag: 'ALMA MATER',
      sec_school_title: 'Beibu Gulf University',
      sec_school_desc: 'By the Qinzhou Bay, where sunset lakes and cosmos flower seas create the most beautiful campus memories.',
      sec_portfolio_tag: 'PORTFOLIO',
      sec_portfolio_title: 'Projects',
      sec_portfolio_desc: 'Computer vision & full-stack projects built with AI assistance. Click images for details.',
      sec_more_tag: 'MORE WORKS',
      sec_more_title: 'Other Projects',
      sec_more_desc: 'More experimental and practice projects.',
      sec_challenges_tag: 'CHALLENGES & INTERESTS',
      sec_challenges_title: 'Challenges & Interests',
      sec_challenges_desc: 'Explorations beyond the classroom.',
      sec_contact_tag: 'CONTACT',
      sec_contact_title: 'Contact',
      sec_contact_desc: 'Let\'s connect and collaborate.',
      hero_greeting_v2: 'Hello, I\'m',
      hero_title_v2: 'Computer Vision Explorer',
      hero_desc_v2: 'Exploring the intersection of computer vision, deep learning, and web technology with AI assistance.',
      hero_stat_years_v2: 'Years Exploring',
      hero_tools_label: 'Tools &amp; Playground',
      hero_tools_desc: 'Exploring Python · PyTorch · YOLO · FastAPI · Vue — building hands-on projects with AI assistance.',
      challenges_label: 'Challenges',
      interests_label: 'Interests',
      ci_challenges_desc: 'Circuit wiring, soldering, electronics competitions — an engineering journey from scratch.',
      ci_interests_desc: 'Reading, exploring, continuous learning.',
      carousel_prev: 'Previous',
      carousel_next: 'Next',
      proj_demo_link: 'Live Demo →',
      proj_no_image: 'No Screenshot Available',
      hometown_more: 'More photos coming soon',
      timeline_stage1_title: 'Getting Started',
      timeline_stage1_desc: 'Started with Hello World and embarked on a journey of technology exploration.',
      timeline_stage2_title: 'Building Foundations',
      timeline_stage2_desc: 'Systematically learned programming languages and data structures.',
      timeline_stage3_title: 'AI & Full-Stack',
      timeline_stage3_desc: 'Learned deep learning, computer vision, and web technologies, building projects with AI assistance.',
      timeline_stage4_title: 'Ongoing Exploration',
      timeline_stage4_desc: 'Diving into AI agents, computer vision, and more — turning technology into real products.',
      footer_built_v2: 'AI Assisted · Independent Work · © 2026 Seeyu',
      page_title_v2: 'Seeyu · Personal Page',
      page_desc_v2: 'Seeyu\'s Personal Page — Computer Vision Explorer from Wuzhou, Beibu Gulf University',
      tw_roles_v2: ['AI Explorer', 'Computer Vision', 'Web Developer'],
      sec_challenges_desc: 'Circuit practice, English contests, hardware DIY',
      sec_portfolio_desc: 'AI, Computer Vision, Full-stack projects',
      sec_contact_desc: 'Open to collaboration and tech exchange',
      timeline_stage1_title: 'Getting Started',
      timeline_stage1_desc: 'First touch with Python and C in freshman year',
      timeline_stage2_title: 'Deep Dive',
      timeline_stage2_desc: 'Full-stack web, databases, networking',
      timeline_stage3_title: 'Project Practice',
      timeline_stage3_desc: 'Multiple AI and web projects, contest awards',
      timeline_stage4_title: 'Continuous Growth',
      timeline_stage4_desc: 'AI agents, computer vision, LLM applications',
      footer_built_v2: '&copy; 2025 Seeyu &middot; AI Assisted',
      page_title_v2: 'Seeyu &middot; Personal Page',
      page_desc_v2: 'Seeyu\'s personal website',
      challenges_label: 'Challenges',
      interests_label: 'Interests',
      view_all_photos: 'View All Photos',
      collapse_photos: 'Collapse Photos',
    ...
    'zh-TW': {
      ...
      nav_challenges: '興趣挑戰',
      sec_hometown_tag: 'HOMETOWN',
      sec_hometown_title: '我的家鄉 · 梧州',
      sec_hometown_desc: '梧州，一座被江水環繞的千年古城。龍母文化源遠流長，騎樓老街見證歲月變遷。',
      sec_school_tag: 'ALMA MATER',
      sec_school_title: '北部灣大學',
      sec_school_desc: '坐落於欽州灣畔，晚霞、湖泊與格桑花海交織出最美的大學時光。',
      sec_portfolio_tag: 'PORTFOLIO',
      sec_portfolio_title: '專案作品集',
      sec_portfolio_desc: '在 AI 輔助下完成的電腦視覺與全端專案。點擊圖片檢視詳情。',
      sec_more_tag: 'MORE WORKS',
      sec_more_title: '其他專案',
      sec_more_desc: '更多練習專案與實驗作品。',
      sec_challenges_tag: 'CHALLENGES & INTERESTS',
      sec_challenges_title: '興趣與挑戰',
      sec_challenges_desc: '學習之外的探索與實踐。',
      sec_contact_tag: 'CONTACT',
      sec_contact_title: '聯絡方式',
      sec_contact_desc: '歡迎交流與合作。',
      hero_greeting_v2: '你好，我是',
      hero_title_v2: '電腦視覺探索者',
      hero_desc_v2: '在 AI 輔助下，探索電腦視覺、深度學習與 Web 技術的交叉地帶。',
      hero_stat_years_v2: '年探索',
      hero_tools_label: 'Tools &amp; Playground',
      hero_tools_desc: '探索 Python · PyTorch · YOLO · FastAPI · Vue 等技術，在 AI 輔助下完成多個實戰專案。',
      challenges_label: '挑戰',
      interests_label: '興趣',
      ci_challenges_desc: '電工接線、電路焊接、電子競賽——從零開始的工科實踐之路。',
      ci_interests_desc: '閱讀、探索、持續學習。',
      carousel_prev: '上一張',
      carousel_next: '下一張',
      proj_demo_link: '線上體驗 →',
      proj_no_image: '暫無專案截圖',
      hometown_more: '更多照片即將新增',
      footer_built_v2: 'AI Assisted · 獨立開發 · © 2026 Seeyu',
      page_title_v2: 'Seeyu · 個人主頁',
      tw_roles_v2: ['AI探索者', '電腦視覺', 'Web 開發者']
    },
    ja: {
      nav_hometown: '故郷',
      nav_school: '大学',
      nav_challenges: '趣味と挑戦',
      sec_hometown_tag: 'HOMETOWN',
      sec_hometown_title: '梧州 · 私の故郷',
      sec_hometown_desc: '川に抱かれた千年の古城。龍母文化が息づき、アーケード街が歴史を語る。',
      sec_school_tag: 'ALMA MATER',
      sec_school_title: '北部湾大学',
      sec_school_desc: '欽州湾に面し、夕焼けの湖とコスモスの花畑が織りなす美しいキャンパス。',
      sec_portfolio_tag: 'PORTFOLIO',
      sec_portfolio_title: 'プロジェクト',
      sec_portfolio_desc: 'AI支援で構築したコンピュータビジョンとフルスタックのプロジェクト。画像をクリックで詳細。',
      sec_more_tag: 'MORE WORKS',
      sec_more_title: 'その他の作品',
      sec_more_desc: '実験的なプロジェクトや練習作品。',
      sec_challenges_tag: 'CHALLENGES & INTERESTS',
      sec_challenges_title: '趣味と挑戦',
      sec_challenges_desc: '教室の外での探求と実践。',
      sec_contact_tag: 'CONTACT',
      sec_contact_title: '連絡先',
      sec_contact_desc: '交流と協力を歓迎します。',
      hero_greeting_v2: 'こんにちは、',
      hero_title_v2: 'コンピュータビジョン探求者',
      hero_desc_v2: 'AI支援でコンピュータビジョン、深層学習、Web技術の交差点を探求しています。',
      hero_tools_label: 'Tools &amp; Playground',
      hero_tools_desc: 'Python · PyTorch · YOLO · FastAPI · Vue などをAI支援で探求。',
      challenges_label: '挑戦',
      interests_label: '趣味',
      carousel_prev: '前へ',
      carousel_next: '次へ',
      proj_demo_link: 'デモを見る →',
      proj_no_image: 'スクリーンショットなし',
      hometown_more: '写真は近日追加予定',
      footer_built_v2: 'AI Assisted · 個人開発 · © 2026 Seeyu',
      page_title_v2: 'Seeyu · 個人ページ',
      tw_roles_v2: ['AI探求者', 'CV', 'Web開発者']
    },
    ko: {
      nav_hometown: '고향',
      nav_school: '학교',
      nav_challenges: '도전',
      sec_hometown_tag: 'HOMETOWN',
      sec_hometown_title: '우저우 · 나의 고향',
      sec_hometown_desc: '강물이 감싸는 천년의 고도, 용모문화와 아케이드 거리가 역사를 말하다.',
      sec_school_tag: 'ALMA MATER',
      sec_school_title: '베이부만대학',
      sec_school_desc: '친저우만 기슭, 석양의 호수와 코스모스 꽃밭이 아름다운 캠퍼스를 수놓다.',
      sec_portfolio_tag: 'PORTFOLIO',
      sec_portfolio_title: '프로젝트',
      sec_portfolio_desc: 'AI 지원으로 구축한 컴퓨터 비전 및 풀스택 프로젝트. 이미지를 클릭하여 자세히 보기.',
      sec_more_tag: 'MORE WORKS',
      sec_more_title: '기타 프로젝트',
      sec_more_desc: '실험적이고 연습용 프로젝트들.',
      sec_challenges_tag: 'CHALLENGES & INTERESTS',
      sec_challenges_title: '관심사와 도전',
      sec_challenges_desc: '교실 밖의 탐구와 실천.',
      sec_contact_tag: 'CONTACT',
      sec_contact_title: '연락처',
      sec_contact_desc: '교류와 협력을 환영합니다.',
      hero_greeting_v2: '안녕하세요,',
      hero_title_v2: '컴퓨터 비전 탐구자',
      hero_desc_v2: 'AI 지원으로 컴퓨터 비전, 딥러닝, 웹 기술의 교차점을 탐구합니다.',
      hero_tools_label: 'Tools &amp; Playground',
      hero_tools_desc: 'Python · PyTorch · YOLO · FastAPI · Vue 등을 AI 지원으로 탐구.',
      challenges_label: '도전',
      interests_label: '관심사',
      carousel_prev: '이전',
      carousel_next: '다음',
      proj_demo_link: '라이브 데모 →',
      proj_no_image: '스크린샷 없음',
      hometown_more: '곧 더 많은 사진 추가 예정',
      footer_built_v2: 'AI Assisted · 개인 개발 · © 2026 Seeyu',
      page_title_v2: 'Seeyu · 개인 페이지',
      tw_roles_v2: ['AI 탐구자', 'CV', '웹 개발자']
    },
    it: {
      nav_hometown: 'Città natale',
      nav_school: 'Università',
      nav_challenges: 'Sfide',
      sec_hometown_tag: 'HOMETOWN',
      sec_hometown_title: 'Wuzhou · La mia città',
      sec_hometown_desc: 'Un\'antica città abbracciata dai fiumi, patria della cultura della Madre Drago.',
      sec_school_tag: 'ALMA MATER',
      sec_school_title: 'Università Beibu Gulf',
      sec_school_desc: 'Sulle rive della baia di Qinzhou, tra laghi al tramonto e campi di cosmos in fiore.',
      sec_portfolio_tag: 'PORTFOLIO',
      sec_portfolio_title: 'Progetti',
      sec_portfolio_desc: 'Progetti di computer vision e full-stack realizzati con assistenza AI.',
      sec_more_tag: 'MORE WORKS',
      sec_more_title: 'Altri progetti',
      sec_more_desc: 'Progetti sperimentali e di pratica.',
      sec_challenges_tag: 'CHALLENGES & INTERESTS',
      sec_challenges_title: 'Sfide & Interessi',
      sec_challenges_desc: 'Esplorazioni oltre la classe.',
      sec_contact_tag: 'CONTACT',
      sec_contact_title: 'Contatti',
      sec_contact_desc: 'Connettiamoci e collaboriamo.',
      hero_greeting_v2: 'Ciao, sono',
      hero_title_v2: 'Esploratore di CV',
      hero_desc_v2: 'Esplorando l\'intersezione tra computer vision, deep learning e web con assistenza AI.',
      hero_tools_label: 'Tools &amp; Playground',
      hero_tools_desc: 'Esplorando Python · PyTorch · YOLO · FastAPI · Vue con assistenza AI.',
      challenges_label: 'Sfide',
      interests_label: 'Interessi',
      carousel_prev: 'Precedente',
      carousel_next: 'Successivo',
      proj_demo_link: 'Demo Live →',
      proj_no_image: 'Nessuno screenshot',
      hometown_more: 'Altre foto in arrivo',
      footer_built_v2: 'AI Assisted · Lavoro indipendente · © 2026 Seeyu',
      page_title_v2: 'Seeyu · Pagina personale',
      tw_roles_v2: ['AI Explorer', 'CV', 'Web Dev']
    },
    fr: {
      nav_hometown: 'Ville natale',
      nav_school: 'Université',
      nav_challenges: 'Défis',
      sec_hometown_tag: 'HOMETOWN',
      sec_hometown_title: 'Wuzhou · Ma ville',
      sec_hometown_desc: 'Une ville ancienne entourée de rivières, berceau de la culture du Dragon Mère.',
      sec_school_tag: 'ALMA MATER',
      sec_school_title: 'Université Beibu Gulf',
      sec_school_desc: 'Au bord de la baie de Qinzhou, entre lacs au coucher du soleil et champs de cosmos.',
      sec_portfolio_tag: 'PORTFOLIO',
      sec_portfolio_title: 'Projets',
      sec_portfolio_desc: 'Projets de vision par ordinateur et full-stack réalisés avec l\'aide de l\'IA.',
      sec_more_tag: 'MORE WORKS',
      sec_more_title: 'Autres projets',
      sec_more_desc: 'Projets expérimentaux et d\'entraînement.',
      sec_challenges_tag: 'CHALLENGES & INTERESTS',
      sec_challenges_title: 'Défis & Intérêts',
      sec_challenges_desc: 'Explorations au-delà de la classe.',
      sec_contact_tag: 'CONTACT',
      sec_contact_title: 'Contact',
      sec_contact_desc: 'Connectons-nous.',
      hero_greeting_v2: 'Bonjour, je suis',
      hero_title_v2: 'Explorateur CV',
      hero_desc_v2: 'Explorant l\'intersection de la vision par ordinateur, du deep learning et du web avec l\'IA.',
      hero_tools_label: 'Tools &amp; Playground',
      hero_tools_desc: 'Explorant Python · PyTorch · YOLO · FastAPI · Vue avec l\'aide de l\'IA.',
      challenges_label: 'Défis',
      interests_label: 'Intérêts',
      carousel_prev: 'Précédent',
      carousel_next: 'Suivant',
      proj_demo_link: 'Démo →',
      proj_no_image: 'Pas de capture',
      hometown_more: 'Plus de photos à venir',
      footer_built_v2: 'AI Assisted · Travail indépendant · © 2026 Seeyu',
      page_title_v2: 'Seeyu · Page personnelle',
      tw_roles_v2: ['Explorateur IA', 'CV', 'Développeur Web']
    }
  };
  for (var lang in v2) {
    if (i18nMap[lang]) {
      Object.assign(i18nMap[lang], v2[lang]);
    }
  }
})();
